...
const Menu = {
  ...
  Main: [
    ...
    { text: "Data Cleaning", icon: "broom", to: "/clean" },
    { text: "Data Preprocessing", icon: "filter", to: "/preprocessing" },
    { text: "Data Visualization", icon: "chart-pie", to: "/visualization" },
                      ...
                      <React.Fragment key={menu}>
                        ...
                        {Menu[menu].map((item) => (
                          <div
                            ...
                            key={item.text}
                          >
                            {item.isDownload?<a title="Download current dataset" class="relative flex flex-row items-center h-11 focus:outline-none border-l-4 border-transparent hover-border pr-6"
