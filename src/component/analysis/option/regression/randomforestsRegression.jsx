    ...
    return (
        <div className='p-4'>
            ...
            <div className={`grid gap-4 p-8 w-auto ${activeTab == 0 ? '' : 'hidden'}`} style={{
                ...
                <Label text='Set parameters: n_estimators'><InlineTip info="Default: 100"/></Label>
                <Input onInput={(e,v) => {
            ...
            <div className={`grid gap-4 p-8 w-auto ${activeTab == 1 ? '' : 'hidden'}`} style={{
                ...
                <DropDown defaultText={'Select criterion'} showOnHover={false} customStyle={`w-64`} customUlStyle='w-64' items={['mse', 'mae']}
                    onSelect={name => {
