...
import {loadScript, useSimpleForm} from '../../util/util'
...
const Page = () => {
    ...
    useEffect(() => {
        ...
        let canvas = document.querySelector('#vis_main')
        canvas.setAttribute('height', Number(height * 5 / 6).toFixed(0) + 'px')
        canvas.setAttribute('width', width + 'px')

        chartRef.current = echarts.init(canvas)
    ...
    return (<div className='flex flex-col items-center w-full h-screen bg-gray-100' ref={parentRef} >
        ...
        <div className='grid grid-cols-3 w-full gap-8 p-8 h-1/6'>
            <MultiSelect defaultOpen={false} defaultText='Select what do you need from a graph' selections={Functions} onSelect={e => setPlotsByFunctions(e)} />
            <DropDown defaultText={'Select Graph Type'} showOnHover={false} customStyle={'h-10 w-96'} customUlStyle={'h-10 w-96'} items={plots} onSelect={e => setCurrentPlot(e)} />
        ...
        <div>
            <canvas id='vis_main' className='' width='1000px' height='800px'>
            </canvas>
        </div>
    </div>)
}
